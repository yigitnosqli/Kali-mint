...
def check_linux_mint():
	"""Detect if running on Linux Mint and display specific warnings"""
	try:
		with open('/etc/os-release', 'r') as f:
			content = f.read()
			if 'Linux Mint' in content or 'linuxmint' in content.lower():
				print("\033[1;32m[✓] Linux Mint detected - Optimized mode active\033[1;m")
				print("\033[1;33m[i] Recommendation: Create a system snapshot before adding Kali repos\033[1;m")
				return True
	except:
		pass
	return False
...
def main():
 ...
 \033[1;36m$$ |\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |
 $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ |
 \__|  \__| \_______|   \____/  \______/  \______/ \__|\__|\__|  \__| V3.0 (2025 Edition) \033[1;m


 \033[1;32m+ -- -- +=[ Author: LionSec | Homepage: www.neodrix.com\033[1;m
 \033[1;32m+ -- -- +=[ Updated for 2025 | Optimized for Linux Mint\033[1;m
 \033[1;32m+ -- -- +=[ 331+ Security Tools \033[1;m
...
5) Help
			...
			''')
				...
				while opcion0 == "1":
					print ('''
1) Add kali linux repositories (kali-rolling - default & frequently updated)
2) Add kali linux repositories (kali-last-snapshot - stable point release)
3) Add experimental branch (kali-experimental)
4) Add bleeding-edge branch (kali-bleeding-edge)
5) Update
6) Remove all kali linux repositories
7) View the contents of sources.list file

					''')
					repo = input("\033[1;32mWhat do you want to do ?> \033[1;m")
					if repo == "1":
						print("\033[1;33m[*] Adding Kali Linux GPG key...\033[1;m")
						os.system("wget -q -O - https://archive.kali.org/archive-key.asc | gpg --dearmor > /etc/apt/trusted.gpg.d/kali-archive-keyring.gpg 2>/dev/null")
						print("\033[1;33m[*] Adding kali-rolling branch (default & frequently updated)...\033[1;m")
						os.system("echo 'deb http://http.kali.org/kali kali-rolling main contrib non-free non-free-firmware' | tee /etc/apt/sources.list")
						print("\033[1;32m[✓] kali-rolling repository configured!\033[1;m")
					elif repo == "2":
						print("\033[1;33m[*] Adding Kali Linux GPG key...\033[1;m")
						os.system("wget -q -O - https://archive.kali.org/archive-key.asc | gpg --dearmor > /etc/apt/trusted.gpg.d/kali-archive-keyring.gpg 2>/dev/null")
						print("\033[1;33m[*] Adding kali-last-snapshot branch (stable point release)...\033[1;m")
						os.system("echo 'deb http://http.kali.org/kali kali-last-snapshot main contrib non-free non-free-firmware' | tee /etc/apt/sources.list")
						print("\033[1;32m[✓] kali-last-snapshot repository configured!\033[1;m")
					elif repo == "3":
						print("\033[1;33m[*] Adding kali-experimental branch...\033[1;m")
						print("\033[1;33m[i] This adds experimental packages to /etc/apt/sources.list.d/\033[1;m")
						os.system("echo 'deb http://http.kali.org/kali kali-experimental main contrib non-free non-free-firmware' | tee /etc/apt/sources.list.d/kali-experimental.list")
						print("\033[1;32m[✓] kali-experimental branch enabled!\033[1;m")
					elif repo == "4":
						print("\033[1;33m[*] Adding kali-bleeding-edge branch...\033[1;m")
						print("\033[1;33m[i] This branch contains packages auto-updated from upstream git\033[1;m")
						os.system("echo 'deb http://http.kali.org/kali kali-bleeding-edge main contrib non-free non-free-firmware' | tee /etc/apt/sources.list.d/kali-bleeding-edge.list")
						print("\033[1;32m[✓] kali-bleeding-edge branch enabled!\033[1;m")
					elif repo == "5":
						print("\033[1;33m[*] Updating package lists...\033[1;m")
						cmd3 = os.system("apt-get update")
						if cmd3 == 0:
							print("\033[1;32m[✓] Update completed successfully!\033[1;m")
						else:
							print("\033[1;31m[!] Update encountered errors. Check your sources.list\033[1;m")
					elif repo == "6":
						...
						delete_list = [
							...
							"# Kali linux repositories | Added by Katoolin 3.0 (2025)\n",
						...
						# Remove additional branch files if they exist
						if os.path.exists("/etc/apt/sources.list.d/kali-experimental.list"):
							os.remove("/etc/apt/sources.list.d/kali-experimental.list")
							print("\033[1;31m[✓] Removed kali-experimental branch\033[1;m")
						if os.path.exists("/etc/apt/sources.list.d/kali-bleeding-edge.list"):
							os.remove("/etc/apt/sources.list.d/kali-bleeding-edge.list")
							print("\033[1;31m[✓] Removed kali-bleeding-edge branch\033[1;m")
					elif repo == "7":
						file = open('/etc/apt/sources.list', 'r')
						print("\n\033[1;36m=== /etc/apt/sources.list ===\033[1;m")
						print(file.read())
						file.close()
						# Show additional branches if they exist
						if os.path.exists("/etc/apt/sources.list.d/kali-experimental.list"):
							print("\n\033[1;36m=== /etc/apt/sources.list.d/kali-experimental.list ===\033[1;m")
							with open('/etc/apt/sources.list.d/kali-experimental.list', 'r') as f:
								print(f.read())
						if os.path.exists("/etc/apt/sources.list.d/kali-bleeding-edge.list"):
							print("\n\033[1;36m=== /etc/apt/sources.list.d/kali-bleeding-edge.list ===\033[1;m")
							with open('/etc/apt/sources.list.d/kali-bleeding-edge.list', 'r') as f:
								print(f.read())
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
...
0) Install all Hardware Hacking tools
						...
						while opcion1 == "14" :
							print ('''
\033[1;36m=+[ Extra - Modern Security Tools (2025)\033[1;m

\033[1;33m[Dependencies]\033[1;m
00) Install Go & Rust (Required for some tools)

\033[1;33m[Tools]\033[1;m
1) Wifresti
2) Squid (Proxy Server)
3) Metasploit Framework
4) Dalfox (XSS Scanner) - Requires Go
5) RustScan (Fast Port Scanner) - Requires Rust
6) Gocat (Better than Ncat) - Requires Go
7) Phobos (Gpu and Cpu based port scanner)

0) Install all Extra tools
				''')
							print ("\033[1;32mInsert the number of the tool to install it .\n\033[1;m")
							opcion2 = input("\033[1;36mkat > \033[1;m")
							if opcion2 == "00":
								print("\033[1;33m[*] Installing Go and Rust....\033[1;m")
								print("\033[1;33m[*] This may take a few minutes...\033[1;m")
								print("\n\033[1;36m===> Installing Go (golang)\033[1;m")
								cmd_go = os.system("apt-get install -y golang-go")
								if cmd_go == 0:
									print("\033[1;32m[✓] Go installed successfully!\033[1;m")
									os.system("go version")
								else:
									print("\033[1;31m[!] Go installation failed!\033[1;m")
								
								print("\n\033[1;36m===> Installing Rust (cargo + rust-all)\033[1;m")
								cmd_rust = os.system("apt-get install -y cargo rust-all rustc")
								if cmd_rust == 0:
									print("\033[1;32m[✓] Rust installed successfully!\033[1;m")
									os.system("rustc --version")
									os.system("cargo --version")
								else:
									print("\033[1;31m[!] Rust installation failed!\033[1;m")
								
								if cmd_go == 0 and cmd_rust == 0:
									print("\n\033[1;32m[✓✓✓] All dependencies installed successfully!\033[1;m")
									print("\033[1;36m[i] You can now install Dalfox, RustScan, and Gocat\033[1;m")
								print (" ")
							elif opcion2 == "1":
								...
								print("\033[1;33m[*] Installing Squid proxy server...\033[1;m")
								cmd = os.system("apt-get install -y squid")
								if cmd == 0:
									print("\033[1;32m[✓] Squid installed successfully!\033[1;m")
								print (" ")
							elif opcion2 == "3":
								print("\033[1;33m[*] Installing Metasploit Framework...\033[1;m")
								cmd = os.system("apt-get install -y metasploit-framework")
								if cmd == 0:
									print("\033[1;32m[✓] Metasploit installed! Run 'msfconsole' to start.\033[1;m")
								print (" ")
							elif opcion2 == "4":
								print("\033[1;33m[*] Installing Dalfox (XSS Scanner)...\033[1;m")
								print("\033[1;33m[i] Checking Go installation...\033[1;m")
								os.system("apt-get install -y golang-go 2>/dev/null || true")
								print("\033[1;33m[*] Installing dalfox via go install...\033[1;m")
								cmd = os.system("go install github.com/hahwul/dalfox/v2@latest")
								if cmd == 0:
									print("\033[1;32m[✓] Dalfox installed! Add ~/go/bin to PATH if needed.\033[1;m")
									print("\033[1;36m[i] Usage: dalfox [command]\033[1;m")
								print (" ")
							elif opcion2 == "5":
								print("\033[1;33m[*] Installing RustScan (Fast Port Scanner)...\033[1;m")
								print("\033[1;33m[i] Checking Rust installation...\033[1;m")
								os.system("apt-get install -y cargo rust-all rustc 2>/dev/null || true")
								print("\033[1;33m[*] Cloning RustScan from GitHub...\033[1;m")
								cmd = os.system("cd /opt && git clone https://github.com/bee-san/RustScan.git && cd RustScan && cargo build --release && ln -sf /opt/RustScan/target/release/rustscan /usr/local/bin/rustscan")
								if cmd == 0:
									print("\033[1;32m[✓] RustScan installed successfully!\033[1;m")
									print("\033[1;36m[i] Usage: rustscan -a <IP>\033[1;m")
								print (" ")
							elif opcion2 == "6":
								print("\033[1;33m[*] Installing Gocat (Reverse Shell Tool)...\033[1;m")
								print("\033[1;33m[i] Checking Go installation...\033[1;m")
								os.system("apt-get install -y golang-go 2>/dev/null || true")
								print("\033[1;33m[*] Cloning Gocat from GitHub...\033[1;m")
								cmd = os.system("cd /opt && git clone https://github.com/ibrahmsql/Gocat.git && cd Gocat && go build -o gocat && ln -sf /opt/Gocat/gocat /usr/local/bin/gocat")
								if cmd == 0:
									print("\033[1;32m[✓] Gocat installed successfully!\033[1;m")
									print("\033[1;36m[i] Usage: gocat\033[1;m")
								print (" ")
							elif opcion2 == "7":
								print("\033[1;33m[*] Installing Phobos (Security Framework)...\033[1;m")
								print("\033[1;33m[*] Cloning Phobos from GitHub...\033[1;m")
								cmd = os.system("cd /opt && git clone https://github.com/ibrahmsql/Phobos.git && cd Phobos && chmod +x phobos.py && ln -sf /opt/Phobos/phobos.py /usr/local/bin/phobos")
								if cmd == 0:
									print("\033[1;32m[✓] Phobos installed successfully!\033[1;m")
									print("\033[1;36m[i] Usage: phobos\033[1;m")
								print (" ")
							elif opcion2 == "0":
								print("\033[1;33m[*] Installing all extra modern tools...\033[1;m")
								print("\033[1;33m[*] This may take a while...\033[1;m")
								# Install dependencies first
								print("\n\033[1;36m===> Step 1/2: Installing dependencies (Go, Rust, etc.)\033[1;m")
								os.system("apt-get install -y squid metasploit-framework golang-go cargo rust-all rustc git")
								print("\n\033[1;36m===> Step 2/2: Installing tools\033[1;m")
								# Install Wifresti
								os.system("git clone https://github.com/LionSec/wifresti.git /tmp/wifresti && cp /tmp/wifresti/wifresti.py /usr/bin/wifresti && chmod +x /usr/bin/wifresti")
								# Install Dalfox
								os.system("go install github.com/hahwul/dalfox/v2@latest")
								# Install RustScan
								os.system("cd /opt && git clone https://github.com/bee-san/RustScan.git && cd RustScan && cargo build --release && ln -sf /opt/RustScan/target/release/rustscan /usr/local/bin/rustscan")
								# Install Gocat
								os.system("cd /opt && git clone https://github.com/ibrahmsql/Gocat.git && cd Gocat && go build -o gocat && ln -sf /opt/Gocat/gocat /usr/local/bin/gocat")
								# Install Phobos
								os.system("cd /opt && git clone https://github.com/ibrahmsql/Phobos.git && cd Phobos && chmod +x phobos.py && ln -sf /opt/Phobos/phobos.py /usr/local/bin/phobos")
								print("\033[1;32m[✓] All extra tools installed!\033[1;m")
							elif opcion2 == "back":
								inicio()
							elif opcion2 == "gohome":
								inicio1()
